...
namespace VT_U2I
{
    public class Config : AbstractConfigSection
    {
        ...
        public SerializedPlayerRole U2IRoleConfig = new SerializedPlayerRole()
        {
            ...
            {
                new SerializedMapPoint("Outside", 187.5507f, -8.07251f, -6.48763f),
                new SerializedMapPoint("Outside", 185.9299f, -8.444763f, -1.784706f),
                new SerializedMapPoint("Outside", 183.4525f, -8.931152f, -1.332999f),
                new SerializedMapPoint("Outside", 180.3424f, -9.680847f, -1.697027f),
                new SerializedMapPoint("Outside", 177.6069f, -10.34033f, -1.783141f),
                new SerializedMapPoint("Outside", 175.2793f, -10.65308f, -1.589358f),
                new SerializedMapPoint("Outside", 174.6662f, -11.2254f, 2.163314f),
                new SerializedMapPoint("Outside", 172.6244f, -12.77948f, 9.865286f),
                new SerializedMapPoint("Outside", 174.8324f, -12.73206f, 7.958255f),
                new SerializedMapPoint("Outside", 174.9952f, -12.05273f, 5.345505f),
                new SerializedMapPoint("Outside", 174.7792f, -11.40039f, 2.836424f),
                new SerializedMapPoint("Outside", 174.6662f, -11.2254f, 2.163314f),
            }
        };
        ...
        public SerializedPlayerRole U2ILiaisonRoleConfig = new SerializedPlayerRole()
        {
            ...
            SpawnPoints = new List<SerializedMapPoint>()
            {
                 new SerializedMapPoint("Outside", 187.6646f, -5.909363f, -28.50043f)
            }
        };
