...
{
    public class ICIntrusConfig : AbstractConfigSection, IBaseConfig
    {
        [Description("The MapPoint where Intrus should Spawn")]
        public SerializedMapPoint SpawnPoint = new SerializedMapPoint("HCZ_Room3ar", -1.792f, 1.330017f, -0.004005589f);

        [Description("The Amount of Health Intrus has")]
        public int Health = 100;

        [Description("The Items Intrus spawns with")]
        public List<SerializedItem> Items = new List<SerializedItem>() { new SerializedItem((int)ItemType.Medkit, 35, 0, 0, 0, Vector3.one) };

        [Description("The Chanche of which IC Intrus spawns")]
        public int SpawnChance = 25;

        [Description("The Amount of Players Required in order to have the Chanche that IC Intrus can spawn")]
        public int RequiredPlayers = 0;

        [Description("The name of the IC Intrus")]
        public string RoleName = "NONE";

        [Description("The Amount of Health IC Intrus has")]
        public int ArtificialHealth = 0;

        [Description("The Amount of Health IC Intrus has")]
        public int MaxArtificialHealth = 100;

        [Description("The Amount of Health TestRole has")]
