...
{
    public class SCP008Config : AbstractConfigSection, IBaseConfig
    {
        [Description("The MapPoint where SCP008 should Spawn")]
        public SerializedMapPoint SpawnPoint = new SerializedMapPoint("HCZ_Room3ar", -1.792f, 1.330017f, -0.004005589f);

        [Description("The Amount of Health SCP008 has")]
        public int Health = 100;

        [Description("The Items SCP008 spawns with")]
        public List<SerializedItem> Items = new List<SerializedItem>() { new SerializedItem((int)ItemType.Medkit, 35, 0, 0, 0, Vector3.one) };

        [Description("The Chanche of which SCP008 spawns")]
        public int SpawnChance = 25;

        [Description("The Amount of Players Required in order to have the Chanche that SCP008 can spawn")]
        public int RequiredPlayers = 0;

        [Description("The name of the SCP008")]
