...
{
    public class TestClassConfig : AbstractConfigSection, IBaseConfig
    {
        [Description("The MapPoint where TestRole should Spawn")]
        ...
        [Description("The Items TestRole spawns with")]
        public List<SerializedItem> Items = new List<SerializedItem>() { new SerializedItem((int)ItemType.Medkit, 35, 0, 0, 0, Vector3.one) };

        [Description("The Chance of which TestRole spawns")]
        public int SpawnChance = 0;

        [Description("The Amount of Players Required in order to have the Chanche that TestRole can spawn")]
        public int RequiredPlayers = 0;

        [Description("The name of the TestRole")]
