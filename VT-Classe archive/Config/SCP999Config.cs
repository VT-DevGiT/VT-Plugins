...
{
    public class SCP999Config : AbstractConfigSection, IBaseConfig
    {
        [Description("The MapPoint where SCP999 should Spawn")]
        public SerializedMapPoint SpawnPoint = new SerializedMapPoint("HCZ_Room3ar", -1.792f, 1.330017f, -0.004005589f);

        [Description("The Amount of Health SCP999 has")]
        public int Health = 100;

        [Description("The Items SCP999 spawns with")]
        public List<SerializedItem> Items = new List<SerializedItem>() { new SerializedItem((int)ItemType.Medkit, 35, 0, 0, 0, Vector3.one) };

        [Description("The Chanche of which SCP999 spawns")]
        public int SpawnChance = 25;

        [Description("The Amount of Players Required in order to have the Chanche that SCP999 can spawn")]
        public int RequiredPlayers = 0;

        [Description("The name of the SCP999")]
