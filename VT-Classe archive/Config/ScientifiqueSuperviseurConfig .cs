...
{
    public class ScientifiqueSuperviseurConfig : AbstractConfigSection, IBaseConfig
    {
        [Description("The MapPoint where Supervising Scientist should Spawn")]
        public SerializedMapPoint SpawnPoint = new SerializedMapPoint("HCZ_Room3ar", -1.792f, 1.330017f, -0.004005589f);

        [Description("The Amount of Health supervising scientist has")]
        public int Health = 100;

        [Description("The Items supervising scientist spawns with")]
        public List<SerializedItem> Items = new List<SerializedItem>() { new SerializedItem((int)ItemType.Medkit, 35, 0, 0, 0, Vector3.one) };

        [Description("The Chanche of which supervising scientist spawns")]
        public int SpawnChance = 25;

        [Description("The Amount of Players Required in order to have the Chanche that supervising scientist can spawn")]
        public int RequiredPlayers = 0;

        [Description("The name of the supervising scientist")]
