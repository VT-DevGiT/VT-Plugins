...
{
    public class NTFExpertPyrotechnieConfig : AbstractConfigSection, IBaseConfig
    {
        [Description("The MapPoint where NTF Expert Pyrotechnie should Spawn")]
        public SerializedMapPoint SpawnPoint = new SerializedMapPoint("HCZ_Room3ar", -1.792f, 1.330017f, -0.004005589f);

        [Description("The Amount of Health NTF Expert Pyrotechnie has")]
        public int Health = 100;

        [Description("The Items NTF Expert Pyrotechnie spawns with")]
        public List<SerializedItem> Items = new List<SerializedItem>() { new SerializedItem((int)ItemType.Medkit, 35, 0, 0, 0, Vector3.one) };

        [Description("The Chance of which NTF Expert Pyrotechnie spawns")]
        public int SpawnChance = 25;

        [Description("The Amount of Players Required in order to have the Chanche that NTF Expert Pyrotechnie can spawn")]
        public int RequiredPlayers = 0;

        [Description("The name of the NTF Expert Pyrotechnie")]
