...
namespace VTEscape
{
    public class Config : AbstractConfigSection
    {
        ...
        public List<SerializedEscapeConfig> EscapeList = new List<SerializedEscapeConfig>()
        {
            ...
            new SerializedEscapeConfig(EscapeEnum.MTF, RoleEnum.Scp049, TeamEnum.None, false, RoleEnum.Spectator),
            new SerializedEscapeConfig(EscapeEnum.MTF, RoleEnum.None, TeamEnum.SCP, false, RoleEnum.Spectator, true, "LOKI - 5 procedure is engaged . the Alfa warhead is started, evacuat the site immediately ."),
