...
namespace VTCustomClass.PlayerScript
{
    public class NTFLieutenantColonel : AbstractRole
    {
        ...
        protected override string RoleName => Plugin.Instance.Config.LtnConlonelName;

        protected override SerializedPlayerRole Config => Plugin.Instance.Config.LtnConlonelConfig;
    }
}