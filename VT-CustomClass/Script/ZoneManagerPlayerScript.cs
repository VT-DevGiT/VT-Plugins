...
{
    public class ZoneManagerScript : AbstractRole
    {
        ...
        protected override string RoleName => Plugin.Instance.Config.ZoneManagerName;

        protected override SerializedPlayerRole Config => Plugin.Instance.Config.ZoneManagerConfig;
    }
}
