...
{
    public class ConfigAndersonEngineer : AbstractConfigSection
    {
        ...
        public SerializedPlayerInventory inventory = new SerializedPlayerInventory()
        {
            ...
            {
                new SerializedPlayerItem((int)ItemType.KeycardChaosInsurgency, 75, 0, 0, 0, Vector3.one, 100, true),
        ...
        public string RoleName = "<color=yellow>Anderson Engineer</color>";
    }
}